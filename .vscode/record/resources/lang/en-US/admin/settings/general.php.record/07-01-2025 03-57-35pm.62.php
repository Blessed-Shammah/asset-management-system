...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'show_url_in_emails_help_text'      => 'Uncheck this box if you do not wish to link back to your s installation in your email footers. Useful if most of your users never login. ',
    'text_pt'        => 'pt',
