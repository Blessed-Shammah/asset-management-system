...
return [
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import assets, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones provided in the sample documentation.</a>.',
    ...
    'version' => 'Version',
    'build' => 'build',
    'footer_credit' => 'RFID/BARCODE ASSET MANAGEMENT software, made with <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">love</span> by <a href="https://amband.co.ke" rel="noopener">@AMBAND</a>.',
